...
namespace PetMatch
{
	...
	public partial class SettingsPage : ContentPage
	{
        ...
        private async void SettingsButton_Clicked(object sender, EventArgs e)
        {
            ...
            comm  = new SqlCommand("UPDATE USERPET SET Username = @Username,Email= @Email, Phone= @Phone, UserLocation=@UserLocation , Petname=@Petname, Petbreed=@Petbreed , Petage=@Petage, Petgender=@Petgender, Password = @Password WHERE Email = @lul", cnn);

            
           
            comm.Parameters.AddWithValue("@Username", usernameSetting.Text.Trim());
            comm.Parameters.AddWithValue("@Email", emailSetting.Text.Trim());
            comm.Parameters.AddWithValue("@Phone", userphonesetting.Text.Trim());
            comm.Parameters.AddWithValue("@UserLocation", RegisterCityPicker.SelectedItem.ToString());
            comm.Parameters.AddWithValue("@Petname", petnameSetting.Text.Trim());
            comm.Parameters.AddWithValue("@PetBreed", RegisterPetBreedPicker.SelectedItem.ToString());
            comm.Parameters.AddWithValue("@Petage", RegisterPetAgePicker.SelectedItem.ToString());
            comm.Parameters.AddWithValue("@Petgender", RegisterPetGenderPicker.SelectedItem.ToString());
            comm.Parameters.AddWithValue("@Password", PasswordSetting.Text.Trim());
            comm.Parameters.AddWithValue("@lul", MainPage.UpdateS);
